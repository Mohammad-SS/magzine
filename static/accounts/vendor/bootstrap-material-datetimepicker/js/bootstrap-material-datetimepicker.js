(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: true, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, lang: 'en', weekStart: 0, disabledDays: [], shortTime: false, clearButton: false, nowButton: false, cancelText: 'لغو', okText: 'تایید', clearText: 'Clear', nowText: 'Now', switchOnClick: false, triggerEvent: 'focus', monthPicker: false, year:true};
   ...
   Plugin.prototype =
           {
              ...
              constructHTMLCalendar: function (date, calendar)
              {
                 ...
                 var week=['ش','1 ش','2 ش','3 ش','4 ش','5 ش','ج'];
                 for (var i = 0; i < calendar.week.length; i++)
                 {
                    _template += '<th>' + week[i] + '</th>';
                 }

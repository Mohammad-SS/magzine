    ...
    sidebarStyleSelect.on('change', function() {
        if(body.attr('data-layout') === "horizontal") {
            if(this.value === "overlay") {
                alert("با عرض پوزش! همپوشانی در چیدمان افقی امکان پذیر نیست.");
                return;
            }
        }
        ...
        if(body.attr('data-layout') === "vertical") {
            if(body.attr('data-container') === "boxed" && this.value === "full") {
                alert("با عرض پوزش! منوی کامل در طرح بندی کادر عمودی موجود نیست.");
                return;
            }

            if(this.value === "modern" && body.attr('data-sidebar-position') === "fixed") {
                alert("با عرض پوزش! طرح بندی نوار کناری مدرن در موقعیت ثابت موجود نیست. لطفا موقعیت نوار کناری را به Static تغییر دهید.");
                return;
            }
        }

(function($) {
 ...
 var dzChartlist = function(){
	...
	var chartWidget4 = function(){
		...
		let barChartData2 = {
			defaultFontFamily: 'iransans',
			labels: ['بیست', 'نوزده', 'هجده', 'هفده', 'شانزده', 'پانزده', 'چهارده', 'سیزده', 'دوازده', 'یازده', 'ده', 'نه', 'هشت', 'هفت', 'شش', 'پنج', 'چهار', 'سه', 'دو', 'یک'],
			datasets: [{
				label: 'هزینه',
	...
	var chartWidget9 = function(){
		...
		new Chart(chart_widget_9, {
			type: "line",
			data: {
				labels: [ "دی", "آذر", "آبان", "مهر", "شهریور", "مرداد", "تیر", "خرداد", "اردیبهشت", "فروردین","اسفند", "بهمن", "دی", "آذر", "آبان", "مهر", "شهریور", "مرداد", "تیر", "خرداد", "اردیبهشت", "فروردین","اسفند", "بهمن", "دی", "آذر", "آبان", "مهر", "شهریور", "مرداد", "تیر", "خرداد", "اردیبهشت", "فروردین"],
				datasets: [{
					label: "آمار فروش",
	...
	var chartWidget11 = function(){
		...
		new Chart(chart_widget_11, {
			type: "line",
			data: {
				labels: ["اسفند", "بهمن", "دی", "آذر", "مهر", "فروردین"],
				datasets: [{
					label: "آمار فروش",
	...
	var chartWidget14 = function(){
		...
		new Chart(chart_widget_14, {
			...
			data: {
				defaultFontFamily: 'iransans',
				labels: ["اسفند", "بهمن", "دی", "آذر", "آبان", "مهر", "فروردین"],
				datasets: [
					{
						label: "اولین مجموعه داده من",
	...
	var chartWidget15 = function(){
		...
		new Chart(chart_widget_15, {
			...
			data: {
				defaultFontFamily: 'iransans',
				labels: ["اسفند", "بهمن", "دی", "تیر", "خرداد", "اردیبهشت", "فروردین"],
				datasets: [
					{
						label: "اولین مجموعه داده من",
	...
	var chartWidget17 = function(){
		...
		if(jQuery('#chart_widget_17').length > 0 ){
			...
			new Chart(chart_widget_17, {
				type: "line",
				data: {
					labels: ["اسفند", "بهمن", "دی", "آذر", "آبان", "مهر", "شهریور", "مرداد", "تیر", "خرداد", "اردیبهشت", "فروردین","اسفند", "بهمن", "دی", "آذر", "آبان", "مهر", "شهریور", "مرداد", "تیر", "خرداد", "اردیبهشت", "فروردین"],

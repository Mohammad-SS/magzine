 ...
 var dzChartlist = function(){
	...
	var simpleLineChart = function(){
		...
		new Chartist.Line('#simple-line-chart', {
			labels: ['مرداد', 'تیر', 'خرداد', 'اردیبهشت', 'ف'],
			series: [
			  [12, 9, 7, 8, 5],
			  [2, 1, 3.5, 7, 3],
			  [1, 3, 4, 5, 6]
	...
	var svgAnimationChart = function(){
		...
		var chart = new Chartist.Line('#svg-animation', {
			labels: ['شهریور', 'مرداد', 'تیر', 'خرداد', 'اردیبهشت', 'ف'],
			series: [
			  [1, 5, 2, 5, 4, 3],
			  [2, 3, 4, 8, 1, 2],
			  [5, 4, 3, 2, 1, 0.5]
	...
	var overlappingBarsChart = function(){
		...
		var data = {
			labels: ['اس', 'به', 'دی', 'آذ', 'آب', 'مه', 'شه', 'مر', 'تی', 'خر', 'ار', 'فر'],
			series: [
	...
	var multiLineChart = function(){
		...
		new Chartist.Bar('#multi-line-chart', {
			labels: ['سه ماهه اول سال', 'سه ماهه دوم سال', 'سه ماه سوم سال', 'سه ماهه چهارم سال'],
			series: [
